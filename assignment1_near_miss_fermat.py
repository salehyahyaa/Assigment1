"""
Program Title: Fermat's Last Theorem Near Miss Search
File Name: assignment1_near_miss_fermat.py


Description:
Searches for near misses of Fermat's Last Theorem:
    x^n + y^n ≠ z^n
for:
    2 < n < 12
    10 ≤ x ≤ k
...
Whenever a new smallest relative miss is found, prints it.
At the end, prints the best near miss found overall.

Resources Used:
- <LIST RESOURCES HERE, OR "NONE">
"""
